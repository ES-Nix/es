{
  description = "QEMU VM + Docker + pure nixpkgs Flask + tinygrad — buildPythonApplication / withPackages / mkDerivation";
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the Flask + tinygrad app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
