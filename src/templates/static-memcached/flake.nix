{
  description = "A minimal static memcached server in OCI format and a NixOS VM to test it";
  ...
  /*
    ...
    flake \
    lock \
    --override-input nixpkgs 'github:NixOS/nixpkgs/a6c3a6141ec1b367c58ead3f7f846c772a25f4e5' \
    --override-input flake-utils 'github:numtide/flake-utils/11707dc2f618dd54ca8739b309ec4fc024de578b'    
