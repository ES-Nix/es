  ...
  outputs = { self, nixpkgs, flake-utils }: {
    overlays.default = nixpkgs.lib.composeManyExtensions [
      (final: prev: {
        ...
        testVagrantSnapshot = prev.testers.runNixOSTest {
          name = "test-vagrant-snapshot-libvirt-ubuntu";
    ...
    flake-utils.lib.eachSystem suportedSystems (system:
      ...
      in
      {
        ...
        apps = {
          ...
          testVagrantSnapshotDriverInteractive = {
            type = "app";
            program = "${pkgs.lib.getExe pkgs.testVagrantSnapshot.driverInteractive}";
            meta.description = "Run testVagrantSnapshot in interactive mode";
          };
        };
