{
  description = "QEMU VM + Docker + pure nixpkgs FastAPI hello — buildPythonApplication / withPackages / mkDerivation";
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the FastAPI hello world app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
