{
  description = "QEMU VM + Docker + pure nixpkgs Flask + jax — buildPythonApplication / withPackages / mkDerivation";
        ...
        testMyappAsOCIImage = prev.testers.runNixOSTest {
          ...
          nodes.machine =
            { config, pkgs, lib, ... }:
            {
              ...
              config.virtualisation.diskSize = 8192;
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the Flask + jax app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
