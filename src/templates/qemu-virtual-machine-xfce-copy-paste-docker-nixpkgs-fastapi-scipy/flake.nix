{
  description = "QEMU VM + Docker + pure nixpkgs FastAPI + scipy — buildPythonApplication / withPackages / mkDerivation";
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the FastAPI + scipy app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
