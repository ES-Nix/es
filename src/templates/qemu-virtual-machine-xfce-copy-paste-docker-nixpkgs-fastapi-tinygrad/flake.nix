{
  description = "QEMU VM + Docker + pure nixpkgs FastAPI + tinygrad — buildPythonApplication / withPackages / mkDerivation";
          ...
          nodes.machine =
            { config, pkgs, lib, ... }:
            {
              ...
              config.systemd.services.docker-podman-load = {
                ...
                path = with pkgs; [ docker_29 podman ];
                script = ''
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the FastAPI + tinygrad app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
