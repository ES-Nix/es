  ...
  */
  ...
  outputs =
    ...
    let
      ...
      f = { system, username, arg-pkgs, home ? "", stateVersion ? "25.05" }:
        let
          pkgs = arg-pkgs;
    ...
    in
    {
      ...
      */
      homeConfigurations = {
        ...
        "vagrant-ubuntu2204.localdomain" = f { system = "${suportedSystem}"; arg-pkgs = pkgsAllowUnfree; home = ./home.nix; username = "vagrant"; };
