{
  description = "QEMU VM + Docker + pure nixpkgs FastAPI + jax — buildPythonApplication / withPackages / mkDerivation";
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the FastAPI + jax app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
