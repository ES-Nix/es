{
  description = "QEMU VM + Docker + pure nixpkgs FastAPI + numpy — buildPythonApplication / withPackages / mkDerivation";
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the FastAPI + numpy app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
