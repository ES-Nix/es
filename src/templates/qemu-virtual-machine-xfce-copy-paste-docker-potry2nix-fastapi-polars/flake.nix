{
  description = "A QEMU virtual machine with XFCE, copy/paste, Docker, Poetry2nix, FastAPI, Polars";
      ...
      (final: prev: {
        ...
        testMyappAsOCIImage = prev.testers.runNixOSTest {
          ...
          testScript = ''
            ...
            # constant = '{"columns":[{"name":"foo","datatype":"Int64","bit_settings":"","values":[1,2,3]},{"name":"bar","datatype":"Int64","bit_settings":"","values":[6,7,8]}]}'
            # expected = '{"message":"Hello world ' + constant + '"}'
      ...
      in
      {
        ...
        apps = {
          ...
          testMyappAsOCIImageDriverInteractive = {
            ...
            meta.description = "Run the testMyappAsOCIImage tester in interactive mode";
          };
        };
