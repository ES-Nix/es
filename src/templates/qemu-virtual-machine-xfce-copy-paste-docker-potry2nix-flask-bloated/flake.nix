{
  description = "A QEMU virtual machine with XFCE, copy/paste, Docker, Poetry2nix, FastAPI, bloated";
        ...
        testMyappOCIImage = prev.testers.runNixOSTest {
          ...
          nodes.machine =
            { config, pkgs, lib, ... }:
            {
              ...
              config.virtualisation.memorySize = 1024 * 5;
              config.virtualisation.diskSize = 1024 * 15;
              config.virtualisation.cores = 7; # Number of cores.
          ...
          testScript = ''
            ...
            # machine.wait_for_unit("docker-load.service") # TODO
      ...
      in
      {
        ...
        apps = {
          ...
          testMyappOCIImageDriverInteractive = {
            ...
            meta.description = "Run the testMyappOCIImage in interactive mode";
          };
        };
