{
  description = "A QEMU virtual machine with XFCE, copy/paste, Docker, poetry2nix, Flask, JAX";
      ...
      in
      {
        ...
        apps = {
          ...
          testMyappOCIImageDriverInteractive = {
            ...
            meta.description = "Run an interactive test with the myapp OCI Image";
          };
        };
