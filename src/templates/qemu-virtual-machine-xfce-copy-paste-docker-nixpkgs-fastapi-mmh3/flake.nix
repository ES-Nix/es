{
  description = "QEMU VM + Docker + pure nixpkgs FastAPI + mmh3 — buildPythonApplication / withPackages / mkDerivation";
      ...
      in
      {
        ...
        apps = {
          ...
          default = {
            ...
            meta.description = "Run the FastAPI + mmh3 app (buildPythonApplication)";
          };
          automaticVm = {
            type = "app";
